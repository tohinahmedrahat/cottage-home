            ...
            <section className="flex justify-center items-center pb-8 mt-3 mb-12 rounded w-11/12  md:w-[80%] mx-auto">
                ...
                data-aos-duration="2000">
                    <form
                        ...
                        className="max-w-xl md:max-w-2xl   ml-auto
                        bg-gray-50 p-8 rounded-md shadow-xl
                        "
                    >

                        <h1 className='text-2xl text-gray-600 text-center Poppins font-semibold'> CONTACT FORM</h1>
