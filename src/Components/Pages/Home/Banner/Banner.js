    ...
    <div>
      ...
      >
        <div className="max-w-2xl tracking-[1px] mx-auto pt-40 md:pt-[30vh] ">
          ...
          <h1 className="md:text-6xl text-5xl px-[15px] text-white font-[PlayfairDisplay] mb-[45px]">RIGHT HOME CARE
            FOR YOU</h1>
        ...
        <div className= ' mt-[10vh] flex justify-center text-white font-semibold gap-8'>
                    ...
                    <button className=' md:px-8 md:py-4 rounded-full text-xl border-2 border-primary bg-hov2'>
