            ...
            <div className=' pt-10 md:w-[80%] w-[95%] mx-auto'>
               ...
               <hr  className='bg-primary px-5 mt-2 py-[1px] w-[220px]'/>
                ...
                <div className='grid lg:grid-cols-3 md:grid-cols-2 gap-7 '>
                    ...
                    {
                        informations.map((info, index) => <div
                            key={index}
                            className='mt-16
                            p-4'
                        ...
                        >
                            ...
                            <p>
                                                ...
                                                <br />
                                                <label onClick={()=>showDetails(info)} htmlFor="show-details" className="cursor-pointer pt-3 text-lg font-semibold">See More.. </label>
                                            </p>
                            </p>
