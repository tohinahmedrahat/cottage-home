                        ...
                        >
                            ...
                            <div className='flex gap-4 items-center'>
                                <div className='relative'>
                                    <img src={right.img} className='w-16 h-16 rounded-full border-2 border-primary  circle' alt="" />
                ...
                <div>
                    {
                        ...
                        >
                            <div className='flex gap-4 items-center '>
                                <div className='relative'>
                                    <img src={wrong.img} className='w-16 h-16 rounded-full border-2 border-primary circle' alt="" />
