    ...
    return (
        <div className='mt-5 bg-[#EBF8F9] py-16'>
            <div data-aos="fade-up" data-aos-duration="2000">
                ...
                <h1 className='text-center text-gray font-[PlayfairDisplay] text-xl md:text-4xl font-semibold'>Our Response</h1>
                ...
                <div className='flex justify-center text-center mt-8 bg-hov2' >
                    <a href='https://www.cdc.gov/coronavirus/2019-ncov/index.html' target='_blank' className='uppercase text-semibold  text-white rounded-md bg-primary shadow-md px-5 py-3'>
                        Find out More
                    </a>
                </div>
