...
>
  <div className='md:grid grid-cols-4 items-center'>
    ...
    <div className='col-span-1' data-aos="fade-up" data-aos-duration="500">
    ...
    <div className='col-span-2' data-aos="fade-up" data-aos-duration="1000">
...
“A Message from our Directors, Navin and Arvin Shivpal”
  ...
  <span className="text-xl mr-1  ">“Welcome”</span>
   ...
   "Changing Lives, One Student at a Time".
    ...
    <div className='flex justify-end col-span-1' data-aos="fade-up" data-aos-duration="1500">
    <div >
