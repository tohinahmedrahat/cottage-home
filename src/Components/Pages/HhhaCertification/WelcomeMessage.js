...
>
  <div className='md:grid grid-cols-4 items-center md:gap-7 lg:gap-0'>

    <div className='col-span-1 mt-5 md:mt-0' data-aos="fade-up" data-aos-duration="500">
    <h1 className="md:text-2xl font-semibold text-center md:text-start"> Join Our Institute </h1>
    ...
    <div className='lg:col-span-2 md:col-span-3  mt-5 md:mt-0' data-aos="fade-up" data-aos-duration="1000">
