...
const ResourcesCard = () => {
    ...
    return (
        <div className='py-10 min-h-screen bg-[#EBF8F9]'>

            <h1 className='text-center playrify md:text-4xl text-xl font-bold text-primary '> Downloads </h1>
            <hr className='border-[#00a6b2] border-t-[1px]  w-12 mt-2  mb-10 mx-auto' />

            <div className='grid md:grid-cols-2 lg:grid-cols-3 md:w-[90%] mx-auto w-[95%] gap-7'>

                {
                    ...
                    className="card w-96 bg-base-100 shadow-xl mx-auto mt-5 bg-hov3 hover:bg-primary hover:text-white main-card bg-hov2"
                    >
                        
                    <div className="card-body" data-aos="zoom-in" data-aos-duration="1000">
                        <h2 className="text-xl font-normal text-center open-sans">{resource?.title}</h2>
                        
                        <div className="card-actions justify-center mt-6 ">
                            <a href={resource?.link} 
                            target='_blank' className=" custom-ancor  bg-primary text-white px-5 py-2.5
                            hover:bg-secondary open-sans hover:text-white rounded-md shadow-md">Download</a>
                        </div>
                    </div>
                </div>
